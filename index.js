...
var keys =[];
var explosionSound = new Audio("./sounds/invaderkilled.wav");
var tankShot = new Audio("./sounds/shoot.wav")
var tankExplosion = new Audio("./sounds/explosion.wav")
...
function drawScoreSeperateLine(){
  ctx.beginPath();
  ctx.beginPath();       // Start a new path
...
//myAudioElement.addEventListener("canplaythrough", event => {
  ...
  //https://live.staticflickr.com/6077/6144165108_8758c2a5c5_b.jpg
